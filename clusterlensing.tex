...
\label{emcee_ex}
{\bf This example demonstrates the use of the \code{emcee} package \citep{emcee}, to run MCMC chains and fit a model to a measurement of galaxy cluster shear.}
