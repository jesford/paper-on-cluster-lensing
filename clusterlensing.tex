...
%\Sigma(x) = 2 r_{\rm s} \delta_{\rm c} \rho_{\rm crit} \left( \frac{1 - \mathcal{F}(x)}{x^2 - 1} \right),
\end{equation}
where $f(x) = $
%\begin{equation}
%\mathcal{F}(x) = 
%    \begin{cases}
%        \ln{ \left[ \frac{1}{x} + \sqrt{\frac{1}{x^2} - 1} \right]} / \sqrt{1 - x^2}, & \text{for } x < 1; \\        
%        \arccos{(1/x)} / \sqrt{x^2 - 1}, & \text{for } x > 1.
%    \end{cases}
%\end{equation}
\begin{equation}
    \begin{cases}
...
%  =
%    \begin{cases}
%        \frac{4 r_{\rm s} \delta_{\rm c} \rho_{\rm crit}}{x^2} \left[ \frac{2}{\sqrt{1-x^2}} {\rm arctanh} \sqrt{\frac{1-x}{1+x}} + {\rm ln}(x/2) \right], & \text{for } x < 1; \\
%        4 r_{\rm s} \delta_{\rm c} \rho_{\rm crit} \left[ 1 + {\rm ln}(1/2) \right], & \text{for } x = 1; \\
%        \frac{4 r_{\rm s} \delta_{\rm c} \rho_{\rm crit}}{x^2} \left[ \frac{2}{\sqrt{x^2 - 1}} {\rm arctan} \sqrt{\frac{x-1}{1+x}} + {\rm ln}(x/2) \right], & \text{for } x > 1.
%    \end{cases}
%\end{equation}

%\attn{Note: I never coded the below equation, only the one above. Is that true???}
%\begin{equation}
%\Delta\Sigma(x) =
%    \begin{cases}
...
\begin{equation}
    ...
    %\left[ \frac{4}{x^2} + \frac{2}{(x^2 - 1)} \right] \ln \left( \frac{1 + \sqrt{(1-x) / (1+x)} }{1 - \sqrt{(1-x) / (1+x)} } \right) / \sqrt{1 - x^2} \\ + \frac{4}{x^2} \ln \frac{x}{2} - \frac{2}{(x^2 - 1)}, & \text{for } x < 1; \\
...
\end{lstlisting}
%<Quantity [[ 38.60655298, 17.57285034, 4.11253461,   
%0.93809627, 0.23574031], [ 181.91820855, 92.86651598, 27.34020647, 6.94677803, 1.81488253], [ 168.79009041, 86.16480864, 25.36720188, 6.44546415, 1.68391163]] solMass / pc2>
%----------------------------
