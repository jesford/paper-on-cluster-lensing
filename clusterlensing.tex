...
In the default implementation, it is assumed that the peak of the halo density distribution perfectly coincides with the identified halo center, i.e. the centered halo case. However, the user has the option to specify an input parameter \code{offsets} which sets the width of a distribution of centroid offsets. Specifically, \code{offsets} is equivalent to $\sigma_{\rm off}$ in the following Rayleigh distribution...
