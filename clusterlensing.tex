...
plt.xlabel(raxis)
plt.savefig('all_sigma_EXAMPLE.eps')
plt.close()
# output of this plot is in Figure 1
...
plt.savefig('f2.eps')
plt.close()
# output of this plot is in Figure 2
...
plt.savefig('f3.eps')
plt.close()
# output of this plot is in Figure 3
...
\epsscale{1.2}
\plotone{data/f3.eps}
\figcaption[data/f3.eps]{This is a caption.}
\end{figure}
