...
\author{Jes Ford\altaffilmark{1} and Jake VanderPlas}
...
\epsscale{1.2}
\plotone{data/f3.eps}
\figcaption[data/f3.eps]{Same as Figure \ref{f2} but for miscentered profiles. Cluster centroid offsets are assumed to follow a Rayleigh probability distribution (Equation \ref{PofR}, discussed in Section \ref{nfw}), which is convolved with the perfectly centered profiles to achieve this result.}
\end{figure}
