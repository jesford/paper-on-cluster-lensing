...
\end{equation}
The numerical values in these equations are obtained from the simulations described in \citet{Prada12}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{\normalfont{\code{clusters.py}}}
\label{clusters}
The class that ties it all together. And scaling relations.
