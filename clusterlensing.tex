...
{\bf Finally, we use the \code{corner} module \citep{corner} to neatly display the results. Figure \ref{f4} shows that the posterior distribution for the best fit mass and centroid offset overlaps with the input values (blue lines).}
